 ...
 * @author fabio
 */
public abstract class AbstractJavaCodeFragment implements CodeFragment {
   ...
   public static Expression asExpression(Object o) {
      if (o == null) {
         return new JavaLiteralExpression<String>("null");
      } else if (o instanceof Expression) {
         return (Expression) o;
      } else if (o instanceof String) {
         return quote((String) o);
      } else if (Boolean.class.isInstance(o)) {
         return new JavaLiteralExpression<String>(((Boolean) o) ? "true" : "false");
      } else if (Character.class.isInstance(o)) {
         return new JavaLiteralExpression<String>("'" + AbstractParserGenerator.escapeChar((Character) o) + "'");
      } else if (Number.class.isInstance(o)) {
         return new JavaLiteralExpression<String>(((Number) o).toString());
      }
      return new JavaLiteralExpression<String>(o.toString());
   }
   ...
   public static Variable asVariable(Object o) {
      ...
      return new JavaVariable(o.toString());
   }

   public static LiteralExpression<String> quote(String value) {
      return new JavaLiteralExpression<String>("\"" + value + "\"");
   }
}
