 ...
 * @author fabio
 */
public class JavaFunctionDefinition extends JavaBlockStatement implements FunctionDefinition {
   ...
   public JavaFunctionDefinition(EnumSet<Modifier> modifiers, DataType returnDataType, String functionName, VariableDeclaration... arguments) {
   ...
   public JavaFunctionDefinition(EnumSet<Modifier> modifiers, String functionName, VariableDeclaration... arguments) {
   ...
   public FunctionCall call(Object... parameters) {
      ...
      return new JavaFunctionCall(name, arrayAux);
   }
