 ...
 * @author fabio
 */
public class CForStatement extends CBlockStatement implements ForStatement {

   private final Expression initExpression;
   private final Expression testExpression;
   private final Expression incrementExpression;

   public CForStatement(Expression initExpression, Expression testExpression, Expression incrementExpression) {
