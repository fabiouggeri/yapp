...
public abstract class OraclePlSqlVisitor implements NodeVisitor {
   ...
   public void enterOptionalIndexBy(Node node) {}
   public void exitOptionalIndexBy(Node node) {}
   ...
   public void enterNumericDataType(Node node) {}
   public void exitNumericDataType(Node node) {}

   public void enterSmallIntPrecisionDataType(Node node) {}
   public void exitSmallIntPrecisionDataType(Node node) {}

   public void enterCharacterDataType(Node node) {}
   public void exitCharacterDataType(Node node) {}

   public void enterNVarCharDataType(Node node) {}
   public void exitNVarCharDataType(Node node) {}

   public void enterNationalCharacterDataType(Node node) {}
   public void exitNationalCharacterDataType(Node node) {}

   public void enterIntegerDataType(Node node) {}
   public void exitIntegerDataType(Node node) {}

   public void enterIntDataType(Node node) {}
   public void exitIntDataType(Node node) {}

   public void enterSmallIntDataType(Node node) {}
   public void exitSmallIntDataType(Node node) {}

   public void enterRealDataType(Node node) {}
   public void exitRealDataType(Node node) {}
   ...
   public void enterPlSqlFunctionParameter(Node node) {}
   public void exitPlSqlFunctionParameter(Node node) {}

   public void enterPlSqlParameters(Node node) {}
   public void exitPlSqlParameters(Node node) {}
   ...
   public void enterPlSqlParametersList(Node node) {}
   public void exitPlSqlParametersList(Node node) {}

   public void enterPlSqlQualifiedIdentifierRemote(Node node) {}
   public void exitPlSqlQualifiedIdentifierRemote(Node node) {}

   public void enterPlSqlSimpleIdentifierRemote(Node node) {}
   public void exitPlSqlSimpleIdentifierRemote(Node node) {}

   public void enterPlSqlAttributes(Node node) {}
   public void exitPlSqlAttributes(Node node) {}

   public void enterPlSqlQualifiedIdentifier(Node node) {}
   public void exitPlSqlQualifiedIdentifier(Node node) {}
